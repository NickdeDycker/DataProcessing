...
ApplePie.creator = DOM.getElementById("header").getElementsByTagName("p")[0].innerHTML;
var ingredient = DOM.getElementById("ingredient-list").getElementsByTagName('li');

for (var i = 0; i < ingredient.length; i++) {
    ApplePie.ingredients.push(ingredient[i].innerHTML);
}
